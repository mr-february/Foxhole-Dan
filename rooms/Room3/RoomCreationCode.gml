...
// === DAN — spawn at last checkpoint if one exists, otherwise ground floor ===
var _spawn_y = 2888;
if (variable_global_exists("checkpoint3_y") && global.checkpoint3_y > 0) {
    _spawn_y = global.checkpoint3_y - 32;
}
instance_create_layer(300, _spawn_y, "Instances", obj_dan);

// === ENEMIES — SOLDIERS (y = platform_y - 32) ===
instance_create_layer(1568, 2408, "Instances", obj_enemy_soldier);  // L3  right — first contact
instance_create_layer( 832, 1928, "Instances", obj_enemy_soldier);  // L6  center — mid guard
instance_create_layer(1472, 1288, "Instances", obj_enemy_soldier);  // L10 right — upper mid
